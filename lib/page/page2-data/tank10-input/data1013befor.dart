...
class Tank1013BeforePage extends StatefulWidget {
  @override
  _Tank1013BeforePageState createState() => _Tank1013BeforePageState();
}

class _Tank1013BeforePageState extends State<Tank1013BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank10beforecheck13'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank10 : Phosphate | 13:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t1013b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank10beforedata13';
