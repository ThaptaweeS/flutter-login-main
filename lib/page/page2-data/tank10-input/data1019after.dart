...
class Tank1019AfterPage extends StatefulWidget {
  @override
  _Tank1019AfterPageState createState() => _Tank1019AfterPageState();
}

class _Tank1019AfterPageState extends State<Tank1019AfterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank10 : Phosphate | 19:00 (After)'),
      ),
      body: Container(
