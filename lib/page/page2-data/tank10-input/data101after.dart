...
class Tank101AfterPage extends StatefulWidget {
  @override
  _Tank101AfterPageState createState() => _Tank101AfterPageState();
}

class _Tank101AfterPageState extends State<Tank101AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank10aftercheck'));
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t101a';
