...
class Tank1019BeforePage extends StatefulWidget {
  @override
  _Tank1019BeforePageState createState() => _Tank1019BeforePageState();
}

class _Tank1019BeforePageState extends State<Tank1019BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank10beforecheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank10 : Phosphate | 19:00 (Before)'),
      ),
      body: Container(
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t1019b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank10beforedata19';
