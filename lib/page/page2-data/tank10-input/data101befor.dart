...
class Tank101BeforePage extends StatefulWidget {
  @override
  _Tank101BeforePageState createState() => _Tank101BeforePageState();
}

class _Tank101BeforePageState extends State<Tank101BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank10beforecheck'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank10 : Phosphate | 01:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t101b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank10beforedata';
