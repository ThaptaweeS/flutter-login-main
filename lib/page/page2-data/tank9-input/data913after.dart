...
class Tank913AfterPage extends StatefulWidget {
  @override
  _Tank913AfterPageState createState() => _Tank913AfterPageState();
}

class _Tank913AfterPageState extends State<Tank913AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank9aftercheck13'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank9 : Phosphate | 13:00 (After)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t913a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank9afterdata13';
