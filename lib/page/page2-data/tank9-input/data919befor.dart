...
class Tank919BeforePage extends StatefulWidget {
  @override
  _Tank919BeforePageState createState() => _Tank919BeforePageState();
}

class _Tank919BeforePageState extends State<Tank919BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank9beforecheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank9 : Phosphate | 019:00 (Before)'),
      ),
      body: Container(
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t919b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank9beforedata19';
