...
class _Tank919AfterPageState extends State<Tank919AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank9aftercheck19'));
        ...
        TableRow(
          children: [
            ...
            buildTableCell(
                "F.A. (Point)",
                FAController,
                'F.A. ต้องอยู่ระหว่าง 4.0 ถึง 4.7',
                4.0,
                4.7,
                isFAlChecked, (value) {
              setState(() {
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t919a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank9afterdata19';
