...
class Tank91BeforePage extends StatefulWidget {
  @override
  _Tank91BeforePageState createState() => _Tank91BeforePageState();
}

class _Tank91BeforePageState extends State<Tank91BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank9beforecheck'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank9 : Phosphate | 01:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t91b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank9beforedata';
