...
class Tank913BeforePage extends StatefulWidget {
  @override
  _Tank913BeforePageState createState() => _Tank913BeforePageState();
}

class _Tank913BeforePageState extends State<Tank913BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://127.0.0.1:1882/tank9beforecheck13'));
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t913b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank9beforedata13';
