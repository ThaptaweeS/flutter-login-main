...
class Tank1419AfterPage extends StatefulWidget {
  @override
  _Tank1419AfterPageState createState() => _Tank1419AfterPageState();
}

class _Tank1419AfterPageState extends State<Tank1419AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank14Aftercheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank14 : Lubricant | 19:00 (After)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t1419a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank14Afterdata19';
