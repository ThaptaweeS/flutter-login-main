...
class Tank147BeforePage extends StatefulWidget {
  @override
  _Tank147BeforePageState createState() => _Tank147BeforePageState();
}

class _Tank147BeforePageState extends State<Tank147BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://127.0.0.1:1882/tank14beforecheck7'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank14 : Lubricant | 07:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t147b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank14beforedata7';
