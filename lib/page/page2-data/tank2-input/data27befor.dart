...
class Tank27BeforePage extends StatefulWidget {
  @override
  _Tank27BeforePageState createState() => _Tank27BeforePageState();
}

class _Tank27BeforePageState extends State<Tank27BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank2beforecheck7'));
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t27b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank2beforedata7';
