...
class Tank21BeforePage extends StatefulWidget {
  @override
  _Tank21BeforePageState createState() => _Tank21BeforePageState();
}

class _Tank21BeforePageState extends State<Tank21BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank2beforecheck'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank2 : Degreasing | 01:00 (Before)'),
      ),
      body: Container(
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t21b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank2beforedata';
