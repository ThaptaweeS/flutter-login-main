...
class _Tank213AfterPageState extends State<Tank213AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank2aftercheck13'));
  ...
  void fetchdataValue() async {
    ...
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank2fetchdata13'));
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t213a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank2afterdata13';
