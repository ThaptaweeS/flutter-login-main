...
class Tank213AfterPage extends StatefulWidget {
  @override
  _Tank213AfterPageState createState() => _Tank213AfterPageState();
}

class _Tank213AfterPageState extends State<Tank213AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank2aftercheck13'));
  ...
  void fetchdataValue() async {
    ...
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank2fetchdata13'));
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank2 : Degreasing | 13:00 (After)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t213a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank2afterdata13';
