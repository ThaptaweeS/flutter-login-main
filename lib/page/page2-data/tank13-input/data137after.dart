...
class Tank137AfterPage extends StatefulWidget {
  @override
  _Tank137AfterPageState createState() => _Tank137AfterPageState();
}

class _Tank137AfterPageState extends State<Tank137AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank13Aftercheck7'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank13 : Lubricant | 07:00 (After)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t137a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank13Afterdata7';
