...
class Tank1319AfterPage extends StatefulWidget {
  @override
  _Tank1319AfterPageState createState() => _Tank1319AfterPageState();
}

class _Tank1319AfterPageState extends State<Tank1319AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank13Aftercheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank13 : Lubricant | 19:00 (After)'),
      ),
      body: Container(
        ...
        TableRow(
          children: [
            buildTableCell(
              "Concentration (%)",
              ConController,
              "Con ต้องอยู่ระหว่าง 1.0 ถึง 2.5",
              1.0,
              2.5,
              isConChecked,
              (value) {
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t1319a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank13Afterdata19';
