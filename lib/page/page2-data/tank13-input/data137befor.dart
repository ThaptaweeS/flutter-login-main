...
class Tank137BeforePage extends StatefulWidget {
  @override
  _Tank137BeforePageState createState() => _Tank137BeforePageState();
}

class _Tank137BeforePageState extends State<Tank137BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank13beforecheck7'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank13 : Lubricant | 07:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t137b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank13beforedata7';
