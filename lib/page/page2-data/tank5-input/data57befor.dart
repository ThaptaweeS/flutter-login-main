...
class Tank57BeforePage extends StatefulWidget {
  @override
  _Tank57BeforePageState createState() => _Tank57BeforePageState();
}

class _Tank57BeforePageState extends State<Tank57BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank5beforecheck7'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank5 : Acid Picking No.1 | 07:00 (Before)'),
      ),
      body: Container(
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t57b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank5beforedata7';
