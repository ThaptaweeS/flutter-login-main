...
class Tank819BeforePage extends StatefulWidget {
  @override
  _Tank819BeforePageState createState() => _Tank819BeforePageState();
}

class _Tank819BeforePageState extends State<Tank819BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank8beforecheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank8 : Surface Condition | 19:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t819b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank8beforedata19';
