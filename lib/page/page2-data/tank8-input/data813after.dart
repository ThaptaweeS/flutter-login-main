...
class _Tank813AfterPageState extends State<Tank813AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8aftercheck13'));
  ...
  void fetchdataValue() async {
    ...
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8fetchdata13'));
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t813a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank8afterdata13';
