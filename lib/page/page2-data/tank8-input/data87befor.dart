...
class _Tank87BeforePageState extends State<Tank87BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8beforecheck7'));
  ...
  void fetchdataValue() async {
    ...
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8fetchdata7'));
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
  ...
  void sendDataToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t87b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank8beforedata7';
