...
class Tank87AfterPage extends StatefulWidget {
  @override
  _Tank87AfterPageState createState() => _Tank87AfterPageState();
}

class _Tank87AfterPageState extends State<Tank87AfterPage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8aftercheck7'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank8 : Surface Condition | 07:00 (after)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t87a';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank8afterdata7';
