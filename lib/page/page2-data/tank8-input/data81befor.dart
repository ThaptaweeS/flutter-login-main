...
class Tank81BeforePage extends StatefulWidget {
  @override
  _Tank81BeforePageState createState() => _Tank81BeforePageState();
}

class _Tank81BeforePageState extends State<Tank81BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response =
          await http.post(Uri.parse('http://127.0.0.1:1882/tank8beforecheck'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank8 : Surface Condition | 01:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1882/t81b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1882/tank8beforedata';
