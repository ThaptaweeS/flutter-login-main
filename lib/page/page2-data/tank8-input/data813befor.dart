...
class Tank813BeforePage extends StatefulWidget {
  @override
  _Tank813BeforePageState createState() => _Tank813BeforePageState();
}

class _Tank813BeforePageState extends State<Tank813BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://172.23.10.51:1111/tank8beforecheck13'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank8 : Surface Condition | 13:00 (Before)'),
      ),
      body: Container(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://172.23.10.51:1111/t813b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://172.23.10.51:1111/tank8beforedata13';
