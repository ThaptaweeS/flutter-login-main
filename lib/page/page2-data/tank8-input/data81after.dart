...
class Tank81AfterPage extends StatefulWidget {
  @override
  _Tank81AfterPageState createState() => _Tank81AfterPageState();
}

class _Tank81AfterPageState extends State<Tank81AfterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank8 : Surface Condition | 01:00 (after)'),
      ),
      body: Container(
