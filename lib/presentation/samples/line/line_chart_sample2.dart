...
class _LineChartSample22State extends State<LineChartSample22> {
  ...
  @override
  Widget build(BuildContext context) {
    double chartHeight = 500; // สูงของพื้นที่กราฟ
    double minY = 20; // minY ของกราฟ
    double maxY = 50; // maxY ของกราฟ
    ...
    return AspectRatio(
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
            top: calculateTopPosition(40, minY, maxY, chartHeight),
            right: 30,
            child: Text(
              'USL: 40',
              style: TextStyle(
          ...
          Positioned(
            top: calculateTopPosition(30, minY, maxY, chartHeight),
            right: 18,
            child: Text(
              'LSL: 30',
              style: TextStyle(
          ...
          Positioned(
            top: calculateTopPosition(33, minY, maxY, chartHeight),
            right: 18,
            child: Text(
              'UCL: 33',
              style: TextStyle(
  ...
  double calculateTopPosition(
    ...
    double position = (1 - normalizedValue) * chartHeight;
    double textHeight = 12.0; // ขนาดความสูงของข้อความ
    double paddingAdjustment =
        chartHeight * 0.05; // ปรับให้สอดคล้องกับขนาดหน้าจอ

    return position - textHeight / 2 - paddingAdjustment;
  }
            ...
            spots: ((() {
              if (widget.historyChartData.length == 1 &&
                  double.parse(ConverstStr(
                          widget.historyChartData[0].resultApprove)) >
                      0) {
                return [
                  FlSpot(
                      1,
